...
def swapAttrib(attribDict: dict, swapA: str, swapB: str, origid: str = "") -> None:
...
class changModel:
    ...
    def detreminModel(self, car: float, bicycle: float, pt: float) -> str:
...
if __name__ == "__main__":
    ...
    #         for leg in legs:
    #             leg.set("mode", model)
    #             attributes = leg.findall("attributes")
    #             for attribute in attributes:
    #                 attributeSub = attribute.findall("attribute")
    #                 for attrib in attributeSub:
    #                     attrib.text = model
    # b.write()
